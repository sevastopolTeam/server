...
#error #include "mongoc/mongoc-libressl-private.h"
#error #include "mongoc/mongoc-stream-tls-libressl.h"
#elif defined(MONGOC_ENABLE_SSL_SECURE_TRANSPORT)
#error #include "mongoc/mongoc-secure-transport-private.h"
#error #include "mongoc/mongoc-stream-tls-secure-transport.h"
#elif defined(MONGOC_ENABLE_SSL_SECURE_CHANNEL)
#error #include "mongoc/mongoc-secure-channel-private.h"
#error #include "mongoc/mongoc-stream-tls-secure-channel.h"
#endif
